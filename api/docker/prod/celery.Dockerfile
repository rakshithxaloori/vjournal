...
ARG AWS_OUTPUT_DOMAIN
ENV AWS_OUTPUT_DOMAIN "$AWS_OUTPUT_DOMAIN"
ARG AWS_CF_KEY_PAIR_ID
ENV AWS_CF_KEY_PAIR_ID "$AWS_CF_KEY_PAIR_ID"
ARG AWS_CF_PRIVATE_KEY
ENV AWS_CF_PRIVATE_KEY "$AWS_CF_PRIVATE_KEY"
...
CMD ["celery", "-A", "vjournal", "worker", "-l", "INFO", "--uid=nobody", "--gid=nogroup", "-Q", "celery"]
