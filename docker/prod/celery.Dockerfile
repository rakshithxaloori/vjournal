...
ARG MEDIACONVERT_REGION_NAME
ENV MEDIACONVERT_REGION_NAME "$MEDIACONVERT_REGION_NAME"
ARG MEDIACONVERT_ENDPOINT_URL
ENV MEDIACONVERT_ENDPOINT_URL "$MEDIACONVERT_ENDPOINT_URL"
ARG SNS_REGION_NAME
